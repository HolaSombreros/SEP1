...
public class RequirementListController
{
  ...
  @FXML private TableColumn<RequirementViewModel, String> status;
  @FXML private TableColumn<RequirementViewModel, String> deadline;
  @FXML private Label userStoryLabel;
